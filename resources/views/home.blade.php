                    ...
                    <div class="banner-content">
                      <div id="svg-animation">
                        ...
                        <div class="mt-5 text-center">
                          ...
                          <a href="https://poocoin.app/tokens/0x0113F2B5BCf6258F6A416FCaF4461df67025948c" class="btn btn-lg btn-gradient-blue btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="margin-left: 25px;">CHART</a>
                        </div>
                    </div>
                </div>
            </div>
